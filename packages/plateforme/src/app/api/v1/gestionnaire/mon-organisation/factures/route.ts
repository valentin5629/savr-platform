...
// Pas d'accès aux factures d'autres organisations. Brouillons exclus : la vue
// client ne lit que les factures émises/payées (§06.04 l.100 et l.913, idem
// route traiteur/factures).
