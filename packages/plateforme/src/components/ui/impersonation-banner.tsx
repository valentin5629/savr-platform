...
>(({ userName, onExit, className }, ref) => (
  ...
  >
    ...
    <button
      onClick={onExit}
      className="absolute right-4 top-1/2 -translate-y-1/2 shrink-0 rounded-savr-md px-3 py-1 text-xs font-semibold bg-savr-primary-950/10 hover:bg-savr-primary-950/20 transition-colors focus-visible:outline-2 focus-visible:outline-offset-2"
    >
