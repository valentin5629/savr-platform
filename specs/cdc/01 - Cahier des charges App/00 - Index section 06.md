...
**Statut** : Validé V1
**Dernière mise à jour** : 2026-05-25 (révision Sujet 1 option A — multi-camions devient interne TMS, plus de N collectes ZD/événement côté Plateforme ; §06.01 mis à jour. Antérieur 2026-05-21 : refonte §06.01 formulaire unique événement-centré : 1 entrée, choix ☐ZD ☐AG, rattachement explicite `evenement_id`, date événement ≠ date collecte. Entrées boutons §06.04/§06.05/§06.11 alignées sur le bouton unique "Programmer un événement".)
