...
| `template_version` | text | NULL | Version figée du gabarit PDF utilisé (ex. `attestation-don@1`), écrite au rendu pour garantir un re-rendu iso. NULL pour les documents émis avant l'introduction du versioning (R2). |
| `created_at` | timestamptz | NOT NULL | |
...
| `template_version` | text | NULL | Version figée du gabarit PDF utilisé (ex. `bordereau-zd@1`), écrite au rendu pour garantir un re-rendu iso. NULL pour les documents émis avant l'introduction du versioning (R2). |
| `created_at` | timestamptz | NOT NULL | |
| `updated_at` | timestamptz | NOT NULL | |
