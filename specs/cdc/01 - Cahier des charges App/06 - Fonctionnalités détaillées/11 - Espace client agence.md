...
| **Lecture référentiel traiteurs = vue whitelist `v_referentiel_traiteurs` (F5, 2026-06-07)** | Policy SELECT élargie sur `organisations` | Vue (id, nom) SECURITY DEFINER pour tout rôle client — libellé unique (nom commercial, ou raison sociale à défaut), zéro exposition siret/logo/raison sociale au-delà du libellé. Colonne `raison_sociale` retirée le 2026-09-22 (revue sécurité PR #363 : elle exposait la raison sociale de tous les traiteurs à tout utilisateur connecté, au-delà du nom autorisé par §06.05 / §06.11 §3). Sans la vue, combobox et fiche collecte restent mortes RLS. |
