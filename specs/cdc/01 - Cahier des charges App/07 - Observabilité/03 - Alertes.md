...
| **Event outbox en échec, collecte imminente** *(ajout 2026-06-10)* | `attempts ≥ 2` ET `date_collecte < now() + 24h` (sans attendre la DLQ) | 🔴 critique | Entre le palier 1 h et 24 h l'échec serait silencieux alors que la collecte est ce soir. Vérifier MTS-1, pousser manuellement si besoin |
