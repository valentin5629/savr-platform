...
**Total : 2016400 -> 1951771 octets (-64629, -3.2%)**
...
## 04 - Data Model.md
- octets : 307338 -> 292151 (-15187, -4.9%)
- tokens estimes : ~76834 -> ~73037
...
- ⚠ tombstones en prose a revoir a la main :
    ...
    L1774: **Renommé `montant_fixe_ht` (refonte 2026-05-26)**, puis **renommé `prix_base_ht` (M1.3)**

## 05 - Règles métier.md
- octets : 119949 -> 115589 (-4360, -3.6%)
- tokens estimes : ~29987 -> ~28897
...
- ⚠ tombstones en prose a revoir a la main :
    ...
    L1254: - : **supprimée V1 (décision Val 2026-06-15)** — type `alerte_ops_pesee_anormale` seedé ma
...
- octets : 54328 -> 51147 (-3181, -5.9%)
- tokens estimes : ~13582 -> ~12786
...
- ⚠ tombstones en prose a revoir a la main :
    ...
    L186: > **Retiré V1 (Sujet 5, propagation 2026-05-26)** — contredisait le récap §3.d. Référence 
    L401: 7. **Retiré V1 (propagation Sujet 4 — type vs taille, 2026-05-26)** — « Autre » est une ca
...
- octets : 99030 -> 95894 (-3136, -3.2%)
- tokens estimes : ~24757 -> ~23973
- tombstones supprimes : 6 | fragments barres retires : 13 | en-tetes debarres : 1
- lignes historiques T2 supprimees : 3
- ⚠ tombstones en prose a revoir a la main :
    L432: - — supprimé 2026-05-07 (unification libellé)
    L436: - — **supprimé V1 (revue sobriété 2026-05-30 A1)** : jamais utilisé (ni facturation, ni al
    L1026: - **Fermée 2026-06-07 (F6, tranché Val)** : bouton retiré V1, fusion = script SQL assisté 
...
- octets : 4385 -> 4385 (-0, -0.0%)
- tokens estimes : ~1096 -> ~1096
- tombstones supprimes : 0 | fragments barres retires : 0 | en-tetes debarres : 0
- lignes historiques T2 supprimees : 0

## 03 - Alertes.md
- octets : 5409 -> 5409 (-0, -0.0%)
- tokens estimes : ~1352 -> ~1352
- tombstones supprimes : 0 | fragments barres retires : 0 | en-tetes debarres : 0
- lignes historiques T2 supprimees : 0
...
- octets : 120959 -> 115505 (-5454, -4.5%)
- tokens estimes : ~30239 -> ~28876
...
- ⚠ tombstones en prose a revoir a la main :
    ...
    L548: - → **sans objet V1** (pas de webhook entrant). Conservé pour activation V1.1/V2 : header 
    L1137: - **Event-driven par défaut** *(polling supprimé revue sobriété 2026-05-01 Bloc A A4 — ret
    L1151: - **Supprimés revue sobriété 2026-05-01 Bloc A A4** — retry 3 paliers + dédup `integration
    L1155: - **Supprimé revue sobriété 2026-05-01 Bloc A A1** — bouton sidebar inconditionnel + page 
...
- octets : 94297 -> 92076 (-2221, -2.4%)
- tokens estimes : ~23574 -> ~23019
...
- ⚠ tombstones en prose a revoir a la main :
    ...
    L418: | | *(retiré V1 — F6 2026-06-07, fusion = script SQL hors UI, cf. §06.06 §8)* | — | — |
...
- octets : 6967 -> 6967 (-0, -0.0%)
- tokens estimes : ~1741 -> ~1741
- tombstones supprimes : 0 | fragments barres retires : 0 | en-tetes debarres : 0
- lignes historiques T2 supprimees : 0
...
- octets : 38645 -> 38602 (-43, -0.1%)
- tokens estimes : ~9661 -> ~9650
- tombstones supprimes : 0 | fragments barres retires : 0 | en-tetes debarres : 0
- lignes historiques T2 supprimees : 1
...
- octets : 45646 -> 45603 (-43, -0.1%)
- tokens estimes : ~11411 -> ~11400
- tombstones supprimes : 0 | fragments barres retires : 0 | en-tetes debarres : 0
- lignes historiques T2 supprimees : 1
...
- octets : 53257 -> 53214 (-43, -0.1%)
- tokens estimes : ~13314 -> ~13303
- tombstones supprimes : 0 | fragments barres retires : 0 | en-tetes debarres : 0
- lignes historiques T2 supprimees : 1
