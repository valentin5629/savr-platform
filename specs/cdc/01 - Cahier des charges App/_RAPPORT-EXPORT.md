...
**Total : 295928 -> 280766 octets (-15162, -5.1%)**


## 04 - Data Model.md
- octets : 295928 -> 280766 (-15162, -5.1%)
- tokens estimes : ~73982 -> ~70191
...
- ⚠ tombstones en prose a revoir a la main :
    ...
    L1735: **Renommé `montant_fixe_ht` (refonte 2026-05-26)**, puis **renommé `prix_base_ht` (M1.3)**
