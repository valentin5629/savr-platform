...
Pendant la fenêtre J0 → J+30, alertes M10 émises avec `contexte = 'migration_test'` (cf. §04 addendum §13). Auto-résolues à J+30 via cron `m13_cleanup_legacy` si critical (R\_§13.8). Les warnings restent actives, à traiter normalement par Ops.
