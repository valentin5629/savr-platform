...
- ⚠ tombstones en prose a revoir a la main :
  ...
  L829: - → **supprimée revue sobriété §05 2026-05-01 A3** (code jamais seedé au catalogue M11, R\_
...
- ⚠ tombstones en prose a revoir a la main :
  ...
  L366: - **Supprimé V1 B3** — V1 = virement par défaut (99% cas), modalité atypique tracée dans `  L504: > déjà supprimée revue sobriété 2026-04-30 A3 (validation unitaire seule).
...
- lignes historiques T2 supprimees : 1
- ⚠ tombstones en prose a revoir a la main :
  L92: - **Supprimé revue sobriété 2026-05-01 A3** — remplacé par vue cross-schema `plateforme.v\_
...
- ⚠ tombstones en prose a revoir a la main :
  ...
  L882: - → **Renommé `auth.session*glissante`revue sobriété §05 2026-05-01 C2** (boolean global 
  L888: - : retiré — W11 dégagée A1 2026-04-30
  L901: **Solde paramètres`m13*\*`seedés** : **1** (device_trusted_max_per_user) vs 17 initiaux. 
