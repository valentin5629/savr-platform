...
--             PARTITION BY (extension 2026-09-21, divergence OBS audit_log — le
--             partitionnement contraint la PK, il fait donc partie de la structure
--             diffable ; les partitions elles-mêmes ne sont pas énumérées),
...
-- Regel 2026-09-21 (divergence OBS_20260921_audit-log-colonnes-nommage, option (i) tranchée Val) :
-- noms de colonnes alignés sur 04 - Data Model post-M0.10, id bigint (séquence),
-- PK composite (id, created_at) imposée par PARTITION BY RANGE (created_at).
