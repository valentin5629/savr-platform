...
| 4. Isolation RLS       | 7            | suggestions*attribution_log (staff read, deny presta/chauffeur, append-only strict), parametres_tms.attribution admin-only, masquage suggestion*\* portail presta         |
