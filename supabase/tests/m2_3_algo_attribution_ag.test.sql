...
-- Prestataires shared — UN PAR TRANSPORTEUR.
-- ⚠ Ces fixtures partageaient le prestataire ...050 entre les trois transporteurs
...
VALUES
  ...
  ('a0000000-0000-0000-0000-000000000051'::uuid, 'A Toutes Test', 'ATOUTES_TEST', ARRAY['ag'], 'api', '987654321098765', 'actif'),
  ('a0000000-0000-0000-0000-000000000052'::uuid, 'Manuel Test', 'MANUEL_TEST', ARRAY['ag'], 'manuel', '555555555055555', 'actif')
