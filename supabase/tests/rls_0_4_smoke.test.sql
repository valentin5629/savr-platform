...
VALUES ('0d0d0001-0000-0000-0000-000000000001'::uuid, '11111111-0000-0000-0000-000000000001'::uuid, 'actif', current_date, 10, 'personnalise');
...
SAVEPOINT sp_t15;
INSERT INTO plateforme.packs_antgaspi (id, organisation_id, statut, date_achat, credits_initiaux, type_pack)
VALUES ('0d0d0002-0000-0000-0000-000000000001'::uuid, '11111111-0000-0000-0000-000000000001'::uuid, 'epuise', current_date, 5, 'personnalise');
...
SELECT throws_ok(
  $$INSERT INTO plateforme.packs_antgaspi (id, organisation_id, statut, date_achat, credits_initiaux, type_pack)
    VALUES ('0d0d0003-0000-0000-0000-000000000001', '11111111-0000-0000-0000-000000000001', 'actif', current_date, 5, 'personnalise')$$,
